...
class B2aDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    void SetCalorMaterial(G4String ); //CJC 6.6.14
  ...
  private:
    ...
    G4LogicalVolume*   fLogicCalor;      // pointer to the logical Calorimeter
                                         //CJC 6.6.14

    G4Material*        fTargetMaterial;  // pointer to the target  material
    G4Material*        fChamberMaterial; // pointer to the chamber material
    G4Material*        fCalorMaterial;   // pointer to the calorimeter material
                                         // CJC 6.6.14
