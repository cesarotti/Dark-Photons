...
double NORMAL_FACTOR = 1.8728253857; //This is the factor for 0.5-2
...
void msquared_small_ang() {
  ...
  TFile* file = new TFile("e+e-2yy_latest_small_ang.root");
  ...
  TFile* fileyyy = new TFile("e+e-2yyy_latest_small_ang.root");
  ...
  TFile* fileepluseminusy = new TFile("e+e-2e+e-y_latest_small_ang.root");
...
/*
  ...
  TFile* fileinelastic = new TFile("brian_1e7_pos_1e4_bias_small_ang.root");
  ...
  //REMOVED UNTIL YIMIN PRODUCES PLOT
  //p = (TPad*)canvas->cd(5);
  //hYIMIN->Draw();
