...
// ********************************************************************
//
// $Id: NewBremsstrahlungRelModel.hh 75582 2013-11-04 12:13:01Z gcosmo $
//
// -------------------------------------------------------------------
//
...
//                extention of standard NewBremsstrahlungModel
//
...
#ifndef NewBremsstrahlungRelModel_h
#define NewBremsstrahlungRelModel_h 1
...
public:
  ...
  NewBremsstrahlungRelModel(const G4ParticleDefinition* p = 0, 
			    const G4String& nam = "eBremLPM");

  virtual ~NewBremsstrahlungRelModel();
...
private:
  ...
  NewBremsstrahlungRelModel & operator=(const  NewBremsstrahlungRelModel &right);
  NewBremsstrahlungRelModel(const  NewBremsstrahlungRelModel&);
...
inline void NewBremsstrahlungRelModel::SetCurrentElement(const G4double Z)
{
  if(Z != currentZ) {
    currentZ = Z;
...
inline G4double NewBremsstrahlungRelModel::Phi1(G4double gg, G4double)
{
...
inline G4double NewBremsstrahlungRelModel::Phi1M2(G4double gg, G4double)
{
...
inline G4double NewBremsstrahlungRelModel::Psi1(G4double eps, G4double)
{
...
inline G4double NewBremsstrahlungRelModel::Psi1M2(G4double eps, G4double)
{
...
inline 
void NewBremsstrahlungRelModel::SetLPMconstant(G4double val) 
{
  fLPMconstant = val;
}
...
inline 
G4double NewBremsstrahlungRelModel::LPMconstant() const 
{
  return fLPMconstant;
}

inline void NewBremsstrahlungRelModel::SetLowestKinEnergy(G4double val)
{
  lowestKinEnergy = val;
}
...
inline G4double NewBremsstrahlungRelModel::LowestKinEnergy() const
{
