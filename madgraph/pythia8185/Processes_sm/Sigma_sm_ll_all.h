...
#ifndef Pythia8_Sigma_sm_ll_all_H
#define Pythia8_Sigma_sm_ll_all_H
...
class Sigma_sm_ll_all : public Sigma3Process 
{
  public:
    ...
    virtual string name() const {return "ll_all (sm)";}
...
#endif  // Pythia8_Sigma_sm_ll_all_H
