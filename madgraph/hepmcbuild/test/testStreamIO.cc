...
void read_testIOGenEvent(std::ostream & os)
{
    ...
    const char infile[] = "/home/local1/project/Dark-Photons/madgraph/hepmc/test/testIOGenEvent.input";
...
void read_variousFormats(std::ostream & os)
{
    ...
    const char infile[] = "/home/local1/project/Dark-Photons/madgraph/hepmc/test/testHepMCVarious.input";
    std::ifstream is( infile );
    if( !is ) {
      std::cerr << "cannot open " << infile << std::endl;
      exit(-1);
