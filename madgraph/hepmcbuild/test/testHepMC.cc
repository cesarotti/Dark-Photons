...
void read_testIOGenEvent(std::ostream & os)
{
    ...
    HepMC::IO_GenEvent ascii_in("/home/local1/project/Dark-Photons/madgraph/hepmc/test/testIOGenEvent.input",std::ios::in);
...
void read_variousFormats(std::ostream & os)
{
    ...
    HepMC::IO_GenEvent ascii_in("/home/local1/project/Dark-Photons/madgraph/hepmc/test/testHepMCVarious.input",std::ios::in);
    ascii_in.use_input_units( HepMC::Units::GEV, HepMC::Units::MM );
    // declare another IO_GenEvent for writing out the good events
...
void read_nan(std::ostream & os)
{
    ...
    //
    HepMC::IO_GenEvent xin("/home/local1/project/Dark-Photons/madgraph/hepmc/test/testHepMCVarious.input",std::ios::in);
    ...
    if ( xin.error_type() != 0 ) {
        os << "processing of /home/local1/project/Dark-Photons/madgraph/hepmc/test/testHepMCVarious.input ended with error " 
