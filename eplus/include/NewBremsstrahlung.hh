...
// ********************************************************************
//
// $Id: NewBremsstrahlung.hh 66241 2012-12-13 18:34:42Z gunter $
//
// -------------------------------------------------------------------
//
...
public:
  ...
  NewBremsstrahlung(const G4String& name = "eBrem");

  virtual ~NewBremsstrahlung();
...
private:
  ...
  NewBremsstrahlung & operator=(const NewBremsstrahlung &right);
  NewBremsstrahlung(const NewBremsstrahlung&);
