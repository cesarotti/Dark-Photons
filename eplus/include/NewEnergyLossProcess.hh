...
// ********************************************************************
//
// $Id: NewEnergyLossProcess.hh 76333 2013-11-08 14:31:50Z gcosmo $
// GEANT4 tag $Name:
//
// -------------------------------------------------------------------
//
...
//
//
// File name:     NewEnergyLossProcess
//
...
#ifndef NewEnergyLossProcess_h
#define NewEnergyLossProcess_h 1
...
class NewEnergyLossProcess : public G4VEnergyLossProcess
{
public:

  NewEnergyLossProcess(const G4String& name = "EnergyLoss",
		       G4ProcessType type = fElectromagnetic);

  virtual ~NewEnergyLossProcess();
...
public:
  ...
  void AddCollaborativeProcess(NewEnergyLossProcess*);
...
private:
  ...
  NewEnergyLossProcess(NewEnergyLossProcess &);
  NewEnergyLossProcess & operator=(const NewEnergyLossProcess &right);
  ...
  std::vector<NewEnergyLossProcess*>    scProcesses;
  G4int                                 nProcesses;
...
inline size_t NewEnergyLossProcess::CurrentMaterialCutsCoupleIndex() const 
{
...
inline void NewEnergyLossProcess::SelectModel(G4double kinEnergy)
{
...
inline G4VEmModel* NewEnergyLossProcess::SelectModelForMaterial(
...
inline void 
NewEnergyLossProcess::DefineMaterial(const G4MaterialCutsCouple* couple)
{
...
inline void NewEnergyLossProcess::SetDynamicMassCharge(G4double massratio,
...
inline G4double NewEnergyLossProcess::GetDEDXForScaledEnergy(G4double e)
{
  /*
  G4cout << "NewEnergyLossProcess::GetDEDX: Idx= " 
...
inline G4double NewEnergyLossProcess::GetSubDEDXForScaledEnergy(G4double e)
{
  G4double x = 
...
inline G4double NewEnergyLossProcess::GetIonisationForScaledEnergy(G4double e)
{
  G4double x = 
...
inline 
G4double NewEnergyLossProcess::GetSubIonisationForScaledEnergy(G4double e)
{
  G4double x = fFactor*
...
inline G4double NewEnergyLossProcess::GetScaledRangeForScaledEnergy(G4double e)
{
  //G4cout << "NewEnergyLossProcess::GetScaledRange: Idx= " 
  //	 << basedCoupleIndex << " E(MeV)= " << e 
...
inline G4double 
NewEnergyLossProcess::GetLimitScaledRangeForScaledEnergy(G4double e)
{
  G4double x;
...
inline G4double NewEnergyLossProcess::ScaledKinEnergyForLoss(G4double r)
{
  //G4cout << "NewEnergyLossProcess::GetEnergy: Idx= " 
...
inline G4double NewEnergyLossProcess::GetLambdaForScaledEnergy(G4double e)
{
...
inline G4double 
NewEnergyLossProcess::GetDEDX(G4double& kineticEnergy,
			      const G4MaterialCutsCouple* couple)
{
...
inline G4double 
NewEnergyLossProcess::GetDEDXForSubsec(G4double& kineticEnergy,
				       const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double 
NewEnergyLossProcess::GetRange(G4double& kineticEnergy,
			       const G4MaterialCutsCouple* couple)
{
  G4double x = fRange;
  DefineMaterial(couple);
...
inline G4double 
NewEnergyLossProcess::GetCSDARange(G4double& kineticEnergy, 
				   const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
  G4double x = DBL_MAX;
...
inline G4double 
NewEnergyLossProcess::GetRangeForLoss(G4double& kineticEnergy,
				      const G4MaterialCutsCouple* couple)
{
...
inline G4double 
NewEnergyLossProcess::GetKineticEnergy(G4double& range,
				       const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double 
NewEnergyLossProcess::GetLambda(G4double& kineticEnergy,
				const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
  G4double x = 0.0;
...
inline void NewEnergyLossProcess::ComputeLambdaForScaledEnergy(G4double e)
{
...
inline void NewEnergyLossProcess::SetFluctModel(G4VEmFluctuationModel* p)
{
  fluctModel = p;
}
...
inline G4VEmFluctuationModel* NewEnergyLossProcess::FluctModel()
{
  return fluctModel;
}
...
inline void NewEnergyLossProcess::SetParticle(const G4ParticleDefinition* p)
{
  particle = p;
}
...
inline void NewEnergyLossProcess::SetSecondaryParticle(const G4ParticleDefinition* p)
{
  secondaryParticle = p;
}
...
inline void NewEnergyLossProcess::SetBaseParticle(const G4ParticleDefinition* p)
{
  baseParticle = p;
}
...
inline const G4ParticleDefinition* NewEnergyLossProcess::Particle() const
{
  return particle;
}
...
inline const G4ParticleDefinition* NewEnergyLossProcess::BaseParticle() const
{
  return baseParticle;
}
...
inline const G4ParticleDefinition* NewEnergyLossProcess::SecondaryParticle() const
{
...
inline void NewEnergyLossProcess::SetLossFluctuations(G4bool val)
{
...
inline void NewEnergyLossProcess::SetRandomStep(G4bool val)
{
  rndmStepFlag = val;
}
...
inline void NewEnergyLossProcess::SetIntegral(G4bool val)
{
  integral = val;
}
...
inline G4bool NewEnergyLossProcess::IsIntegral() const 
{
  return integral;
}
...
inline void NewEnergyLossProcess::SetIonisation(G4bool val)
{
  isIonisation = val;
...
inline G4bool NewEnergyLossProcess::IsIonisationProcess() const
{
  return isIonisation;
}
...
inline void NewEnergyLossProcess::SetLinearLossLimit(G4double val)
{
  linLossLimit = val;
}
...
inline void NewEnergyLossProcess::SetMinSubRange(G4double val)
{
  minSubRange = val;
}
...
inline void NewEnergyLossProcess::SetLambdaFactor(G4double val)
{
...
void NewEnergyLossProcess::SetStepFunction(G4double v1, G4double v2)
{
  dRoverRange = v1;
  finalRange = v2;
...
inline void NewEnergyLossProcess::SetLowestEnergyLimit(G4double val)
{
  lowestKinEnergy = val;
}
...
inline G4int NewEnergyLossProcess::NumberOfSubCutoffRegions() const
{
...
inline void NewEnergyLossProcess::SetDEDXBinning(G4int nbins)
{
  nBins = nbins;
}
...
inline void NewEnergyLossProcess::SetLambdaBinning(G4int nbins)
{
  nBins = nbins;
}
...
inline void NewEnergyLossProcess::SetDEDXBinningForCSDARange(G4int nbins)
{
  nBinsCSDA = nbins;
}
...
inline void NewEnergyLossProcess::SetMinKinEnergy(G4double e)
{
  minKinEnergy = e;
}
...
inline G4double NewEnergyLossProcess::MinKinEnergy() const
{
  return minKinEnergy;
}
...
inline void NewEnergyLossProcess::SetMaxKinEnergy(G4double e)
{
  maxKinEnergy = e;
...
inline G4double NewEnergyLossProcess::MaxKinEnergy() const
{
  return maxKinEnergy;
}
...
inline void NewEnergyLossProcess::SetMaxKinEnergyForCSDARange(G4double e)
{
  maxKinEnergyCSDA = e;
}
...
inline G4double NewEnergyLossProcess::CrossSectionBiasingFactor() const
{
  return biasFactor;
}
...
inline G4bool NewEnergyLossProcess::TablesAreBuilt() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::DEDXTable() const
{
  return theDEDXTable;
}
...
inline G4PhysicsTable* NewEnergyLossProcess::DEDXTableForSubsec() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::DEDXunRestrictedTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::IonisationTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::IonisationTableForSubsec() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::CSDARangeTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::SecondaryRangeTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::RangeTableForLoss() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::InverseRangeTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::LambdaTable() const
{
...
inline G4PhysicsTable* NewEnergyLossProcess::SubLambdaTable() const
{
