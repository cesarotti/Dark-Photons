...
// ********************************************************************
//
// $Id: DarkPhoton.cc 68797 2013-04-05 13:27:11Z gcosmo $
//
// -------------------------------------------------------------------
//
// GEANT4 Class file
...
DarkPhoton::DarkPhoton(const G4String& name)
...
G4bool DarkPhoton::IsApplicable(const G4ParticleDefinition& p)
{
...
G4double DarkPhoton::AtRestGetPhysicalInteractionLength(
...
void DarkPhoton::InitialiseProcess(const G4ParticleDefinition*)
{
  if(!isInitialised) {
    isInitialised = true;
    if(!EmModel(1)) { SetEmModel(new DarkPhotonModel(),1); }
...
void DarkPhoton::PrintInfo()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4VParticleChange* DarkPhoton::AtRestDoIt(const G4Track& aTrack,
               const G4Step& )
//
