...
#include "G4ParticleTable.hh"
 ...
 EmStandardPhysics::EmStandardPhysics(G4int ver)
 ...
 void EmStandardPhysics::ConstructProcess()
 {
   ...
   while( (*theParticleIterator)() ){
     ...
     if (particleName == "gamma") {
       ...
       //Bias 2gamma
       G4VEmProcess* eplusProcHiEn = new G4eplusAnnihilationHi();
       /*
       eplusProcHiEn->SetCrossSectionBiasingFactor(1e+05, true);
       eplusProcHiEn->SetMinKinEnergy(4.8*GeV);
       */
       ph->RegisterProcess(eplusProcHiEn, particle);
