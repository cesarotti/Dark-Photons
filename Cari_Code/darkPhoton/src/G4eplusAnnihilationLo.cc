#include "G4eplusAnnihilationLo.hh"
...
G4eplusAnnihilationLo::G4eplusAnnihilationLo(const G4String& name)
...
G4eplusAnnihilationLo::~G4eplusAnnihilationLo()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4bool G4eplusAnnihilationLo::IsApplicable(const G4ParticleDefinition& p)
{
...
G4double G4eplusAnnihilationLo::AtRestGetPhysicalInteractionLength(
...
void G4eplusAnnihilationLo::InitialiseProcess(const G4ParticleDefinition*)
{
  if(!isInitialised) {
    isInitialised = true;
    if(!EmModel(1)) { SetEmModel(new G4eeToTwoGammaModel(),1); }
    EmModel(1)->SetLowEnergyLimit(MinKinEnergy());
    EmModel(1)->SetHighEnergyLimit(4.8*GeV);
...
void G4eplusAnnihilationLo::PrintInfo()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4VParticleChange* G4eplusAnnihilationLo::AtRestDoIt(const G4Track& aTrack,
                                                     const G4Step& )
//
